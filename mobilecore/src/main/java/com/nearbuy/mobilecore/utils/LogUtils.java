...
import com.nearbuy.mobilecore.BuildConfig;


public class LogUtils {
    public static final boolean ENABLE_LOG = BuildConfig.DEBUG ? true : false;
    private static final String LOG_PREFIX = "log_prefix_";
    ...
    private static void outLog(LogLevel loglevel, String tag, String message) {
        try {
            if (AppUtils.isNullOrEmpty(tag) && AppUtils.isNullOrEmpty(message)) {
                return;
            }
